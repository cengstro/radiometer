...
albedo = (0.66 +/- 0.033)  - 0.078 +/- 0.011 * log(Cell Area Percent Cover)
...
IRF = 64 +/- 3.4 log(frac_red_percent)
...
facet_names <- list(
  ...
  'mean_albedo'="Vis+NIR (350-1300 nm)"
)
...
dat %>% 
  ...
  facet_grid(rows = vars(name), labeller = facet_labeller) +
  geom_boxplot() +
  # geom_jitter(width = 0.2) +
  lims(y = c(0,1)) +
  labs(y = "Broadband albedo", y = "Snow type") +
  theme_minimal() #+
  # geom_point()
```
```{r}
